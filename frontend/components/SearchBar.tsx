...
export default function SearchBar() {
    return (
        <div className="w-full relative">
            <input className="w-full pr-8 border-[1px] h-12 border-[#D4DEFE] rounded-full" type="text" />
            <button className="text-gray-400 rounded-full top-3 right-6 absolute w-6 h-6">
